 ...
 */
char *	const	ex_pmisc [] =
{ "indefinido", "vortex", "vacuum", "slip", "ice", "mysterious" };
...
char *  const   ex_flags [] =
{
"hay puerta", "cerrado", "bloqueado", "secreto", "nadar", "segura", "volar", "escalar",
"cavar", "come llave", "nopassdoor", "oculta", "pasadizo", "portal", "r1", "r2",
"puede escalarse", "puede entrar", "puede abandonar", "auto", "no huir", "buscable",
"derribada", "no derribable", "nomob", "ventana", "puede mirar", "electrica", "electrificada"
};

char *  const   sec_flags [] =
{
"dentro", "ciudad", "campo", "bosque", "colinas", "montanya", "agua",
"aguas turbias", "debajo del agua", "aire", "desierto", "dunno", "suelo oceanico",
"bajo tierra", "lava", "pantano", "r1", "r2", "r3", "r4", "r5", "r6", "r7",
"r8", "r9", "r10", "r11", "r12", "r13", "r14", "r15", "r16"
};

char *	const	r_flags	[] =
{
"oscura", "muerte", "nomob", "entre puertas", "pacifica", "neutral", "caotica",
"no magia", "tunel", "privada", "safe", "solitaria", "tienda mascotas", "norecall",
"donaciones", "no dejar todol", "silenciosa", "logeada", "no dejar", "almacen de secta",
"no summoneable", "noastral", "teleport", "teleshowdesc", "sin suelo",
"no suplicar", "arena", "no misil", "r4", "r5", "prototipo", "dnd"
};

char *	const	o_flags	[] =
{
"brillante", "humeante", "oscuro", "leal", "demoniaco", "invisible", "magico", "no dejar", "bendecido",
"anti bueno", "anti malo", "anti neutral", "no desvestir", "inventario",
"anti mago", "anti ladron", "anti guerrero", "anti clerigo", "organico", "metalico",
"donacion", "objeto de clan", "cuerpo de clan", "anti assamita", "anti capadoccio",
"oculto", "envenenado", "cubierto", "putrefacto", "enterrado", "prototipo",
"no localizar", "decadente", "botin", "quest","rare", "unico", "taquilla",
"casual", "autoobjeto" };

char * const   container_flags [] =
{
"cerrable", "puedeforzarse", "cerrado", "cerrado_con_llave", "se_come_llave", "r1", "r2", "r3",
...
{
"returning", "backstabber", "bane", "leal", "haste", "drain",
"lightning_blade"
};
...
"escudo", "encima", "cintura", "munyeca", "munyeca", "cogido", "dual", "orejas", "ojos",
"misil", "detras", "cara", "tobillo", "satelite","r5","r6",
...
"manos", "brazos", "como_escudo", "por_encima", "cintura", "munyeca", "munyeca", "arma",
"sostenido", "dual", "orejas", "ojos", "misil", "detras", "cara", "tobillo", "tobillo",
"satelite","r5","r6","r7","r8","r9","r10","r11","r12","r13"
};

char *	const	area_flags	[] =
{
"nopk", "pklibre", "noteleport", "spelllimit", "autoarea", "r5", "r6", "r7", "r8",
...
char *	const	o_types	[] =
{
"ninguno", "luz", "pergamino", "varita", "baston", "arma", "arma de fuego", "misil",
"tesoro", "armadura", "pocion", "_ropa", "adorno", "basura", "trampa rota",
"contenedor", "nota", "contenedor de liquidos", "llave", "comida", "dinero", "pluma", "bote",
"cuerpo", "cuerpo jugador", "fuente", "pildora", "sangre", "fuente de sangre",
"chatarra", "pipa", "contenedor herbal", "hierba", "incienso", "fuego", "libro", "interruptor",
"elevador", "polea", "boton", "marcador", "runa", "bolsa_runica", "cerilla", "trampa",
"mapa", "portal", "papel", "tinder", "cerradura", "pincho", "enfermedad", "aceite",
"combustible", "vacio1", "vacio2", "misil_arrojadizo", "proyectil", "carcaj", "lapida",
"balsamo", "cocina", "llavero", "perfume", "chance"
};
...
"inmune", "susceptible", "conjuro_de_arma", "suerte", "backstab", "pick", "track",
"steal", "sneak", "hide", "palm", "detrap", "dodge", "peek", "scan", "gouge",
"search", "mount", "disarm", "kick", "parry", "bash", "stun", "punch", "climb",
"grip", "scribe", "brew", "wearspell", "removespell", "estado_mental", "emocion",
"stripsn", "remove", "cavar", "lleno", "sed", "cogorza", "sangre", "cook",
"recurringspell", "contagious", "xaffected", "olor_corporal", "roomflag", "sectortype",
"roomlight", "televnum", "teledelay"
};

char *	const	a_flags [] =
{
"cegado", "invisible", "detect_evil", "detect_invis", "detect_magic",
...
"venomshield", /*"presencia_invisible", "capa_sombria", "sentidos_aguzados",
"celeridad", "potencia", "fortaleza", "traumatizado",*/ "marihuana",
"habilidad", "proteccion_vampirica"/*, "corazon_petreo", "koma"*/
};

char *	const	act_flags [] =
{
"npc", "sentinel", "scavenger",  "banquero", "healer", "aggressive", "stayarea",
"wimpy", "pet", "train", "practice", "immortal", "deadly", "polyself",
"meta_aggr", "guardian", "running", "nowander", "mountable", "mounted",
"scholar", "secretive", "hardhat", "mobinvis", "noassist", "autonomous",
"pacifist", "noattack", "annoying", "statshield", "prototype", "questman",
"noquest", "automob", "ACTUALIZADO", "dominado", "vacio"
};
...
{
"npc", "questor", "boughtpet", "shovedrag", "autoexits", "autoloot", "autosac", "blank",
...
"flee" ,"autogold", "automap", "afk", "invisprompt", "autodanyo",
"abrazado", "sire", "chiquillo", "wizincog", "renacido", "camuflaje",
"presencia", "pkTotal", "afectado_potencia", "afectado_fortaleza",
"afectado_celeridad", "afectado_presencia_invisible", "traumatizado",
"corazon_petreo", "afectado_capasombria", "afectado_sentidos_aguzados", "silencio_mortal",
...
{
"luz", "dedo1", "dedo2", "cuello1", "cuello2", "cuerpo", "cabeza", "piernas",
"pies", "manos", "brazos", "escudo", "encima", "cintura", "munyeca1", "munyeca2",
"arma", "cogido", "dual", "orejas", "ojos", "misil", "detras",
"cara", "tobillo1", "tobillo2"
};
...
void start_editing( CHAR_DATA *ch, char *data )
{
	...
	send_to_char( "Escribe aqui tu texto (/? = help /s = save /c = clear /l = list)\n\r", ch );
	send_to_char( "-----------------------------------------------------------------------\n\r> ", ch );
	if ( ch->editor )
	  stop_editing( ch );
...
void do_goto( CHAR_DATA *ch, char *argument )
{
    ...
    if ( arg[0] == '\0' )
    {
	send_to_char( "A donde quieres ir?\n\r", ch );
	return;
    }
   ...
   if ( !is_number(arg) && (fch=get_char_world(ch, arg)) )
   {
      ...
      {
         pager_printf( ch,
         "Lo siento, pero %s no puede ser molestado.\n\r", fch->name);
         pager_printf( fch,
            "%s intenta molestarte a base de goto.\n\r", ch->name);
         return;
      }
   }
	...
	if ( get_trust( ch ) < sysdata.level_modify_proto )
	{
	    if ( !ch->pcdata || !(pArea=ch->pcdata->area) )
	    {
		send_to_char( "Tienes un area asignada para crear habitaciones.\n\r", ch );
		return;
	    }
	    if ( vnum < pArea->low_r_vnum
	    ||   vnum > pArea->hi_r_vnum )
	    {
		send_to_char( "No esta asignada dentro de tu rango.\n\r", ch );
		return;
	    }
	}
	...
	send_to_char( "Alzas tus manos y concentras todo el poder magico y de la sangre,\n\rpara alterar la realidad...\n\r", ch );
    }
	...
	{
	    send_to_char( "Ahora esta habitacion es privada.\n\r", ch );
	    return;
	}
	else
	    send_to_char( "Rebentando el flag de PRIVADO!\n\r", ch );
    }
	...
	act( AT_IMMORT, "$n $T", ch, NULL,
	    ...
	    ? ch->pcdata->bamfout : "desaparece en medio de un remolino de energia.",  TO_ROOM );
	...
	act( AT_IMMORT, "$n $T", ch, NULL,
	    ...
	    ? ch->pcdata->bamfin : "aparece en medio de un remolino de energia.", TO_ROOM );
...
void do_mset( CHAR_DATA *ch, char *argument )
{
    ...
    if ( IS_NPC( ch ) )
    {
   send_to_char( "Los Mobs no pueden hacer Mset\n\r", ch );
	return;
    }
   ...
   send_to_char( "No tienes descriptor\n\r", ch );
	...
	case SUB_MOB_DESC:
	  ...
	  if ( char_died(victim) )
	  {
		send_to_char( "Tu victima esta muerta!\n\r", ch );
		stop_editing( ch );
		return;
	  }
    ...
    if ( !str_cmp( arg1, "on" ) )
    {
	send_to_char( "Sintaxis: mset <victima|vnum> on.\n\r", ch );
	return;
    }
	...
	{
	    if ( victim )
		send_to_char( "Sintaxis: <campo>  <valor>\n\r",		ch );
	    else
		send_to_char( "Sintaxis: <victima> <campo>  <valor>\n\r",	ch );
	}
	else
	    send_to_char( "Sintaxis: mset <victima> <campo>  <valor>\n\r",	ch );
	send_to_char( "\n\r",						ch );
	send_to_char( "El campo tiene que ser uno de estos:\n\r",			ch );
	send_to_char( "  fue int sab des con car sue sexo clase\n\r",	ch );
	send_to_char( "  oro hp mana move practicas align raza\n\r",	ch );
	send_to_char( "  hitroll damroll armor affected nivel\n\r",	ch );
	send_to_char( "  sed borracho hambre sangre flags\n\r",		ch );
	send_to_char( "  pos defpos part (ver BODYPARTS)\n\r",		ch );
	send_to_char( "  sav1 sav2 sav4 sav4 sav5 (ver SAVINGTHROWS)\n\r", ch );
	send_to_char( "  resistant immune susceptible (ver RIS)\n\r",	ch );
	send_to_char( "  attack defense numattacks\n\r",		ch );
	send_to_char( "  speaking speaks (ver LANGUAGES)\n\r",		ch );
	send_to_char( "  nombre short long description titulo spec clan\n\r", ch );
        send_to_char( "  generacion genepkills genepdeaths\n\r",	ch );
        send_to_char( "  consejo quest qp qpa favor deidad\n\r",		ch );
	send_to_char( "\n\r",						ch );
	...
	if ( value < 0 || value > 30 )
	{
	    send_to_char( "El tiempo entre misiones es de 0 a 30 minutos.\n\r", ch );
	    return;
	}
	...
	if ( value < 1 || value > 30 )
	{
	    send_to_char( "El tiempo para completar misiones es de 1 a 30 minutos.\n\r", ch );
	    return;
	}
	...
	{
	    send_to_char( "El vnum del objeto esta entre estos rangos 0 a 2000000.\n\r", ch );
	    return;
	}
	...
	if ( value < 0 || value > 2000000 )
	{
	    send_to_char( "El vnum de mobs esta entre estos rangos 0 a 2000000.\n\r", ch );
	    return;
	}
	 ...
	 */
	if( !str_prefix( arg2, "familia" ) )
	{
		FAMILIA_DATOS *fam;
		int ok = 0;

		for( fam = primeraFamilia; fam; fam = fam->sig )
			if( !str_cmp( fam->alias, arg3 ) )
				ok = 1;

		if( ok == 0 )
		{
			ch_printf( ch, "Esa familia no existe melonazo.\n\r" );
			return;
		}
		else
		{
			victim->familia = buscaFamilia( arg3 );
			ch_printf( ch, "Familia de %s cambiada, ha pasado a ser de la familia %s", ch->name, victim->familia->nombre );
			return;
		}
	}
	...
	{
	    ch_printf( ch, "El rango de la fuerza es de %d a %d.\n\r", minattr, maxattr );
	    return;
	}
	...
	if ( value < minattr || value > maxattr )
	{
	    ch_printf( ch, "El rango de la inteligencia es de %d a %d.\n\r", minattr, maxattr );
	    return;
	}
	...
	if ( value < minattr || value > maxattr )
	{
	    ch_printf( ch, "El rango de la sabiduria es de %d a %d.\n\r", minattr, maxattr );
	    return;
	}
	...
	if ( value < minattr || value > maxattr )
	{
	    ch_printf( ch, "El rango de la destreza es de %d a %d.\n\r", minattr, maxattr );
	    return;
	}
	...
	if ( value < minattr || value > maxattr )
	{
	    ch_printf( ch, "El rango de la constitucion es de %d a %d.\n\r", minattr, maxattr );
	    return;
	}
	...
	if ( value < minattr || value > maxattr )
	{
	    ch_printf( ch, "El rango del carisma es de %d a %d.\n\r", minattr, maxattr );
	    return;
	}
	...
	if ( value < minattr || value > maxattr )
	{
	    ch_printf( ch, "El rango de la suerte es de %d a %d.\n\r", minattr, maxattr );
	    return;
	}
    ...
    if ( !str_cmp( arg2, "sexo" ) )
    {
	if ( !can_mmodify( ch, victim ) )
	  return;
	if ( value < 0 || value > 2 )
	{
	    send_to_char( "El rango es de 0 a 2.\n\r", ch );
	    return;
	}
	victim->sex = value;
	if ( IS_NPC(victim) && xIS_SET(victim->act, ACT_PROTOTYPE) )
        ...
        if( IS_NPC(victim) )
	{
	  ...
	  {
		ch_printf( ch, "El rango de la clase en no jugadores es de 0 a %d.\n", MAX_NPC_CLASS-1 );
	        return;
	  }
	  victim->class = value;
   ...
   if ( value < 0 || value >= MAX_CLASS )
	{
	    ch_printf( ch, "El rango de la clase es de 0 a %d.\n", MAX_CLASS );
	    return;
	}
	victim->class = value;
	return;
	...
	{
	    ch_printf( ch, "El rango de la raza es de 0 a %d.\n", MAX_RACE-1 );
	    return;
	}
   ...
   if ( value < 0 || value > LEVEL_AVATAR + 50 )
	{
            ch_printf( ch, "El rango del nivel es de 0 a %d.\n\r", LEVEL_AVATAR + 50 );
	    return;
	}
	victim->level = value;
	if ( IS_NPC(victim) && xIS_SET(victim->act, ACT_PROTOTYPE) )
	...
	{
	    send_to_char( "De 1 a 1,000,000 de puntos de vida melonazo.\n\r", ch );
	    return;
	}
	...
	{
	    send_to_char( "De 1 a 1,000,000 de mana melonazo.\n\r", ch );
	    return;
	}
	...
	if ( value < 0 || value > 1000000 )
	{
	    send_to_char( "De 1 a 1,000,000 de move melonazo.\n\r", ch );
	    return;
	}
    ...
    if ( !str_cmp( arg2, "practicas" ) )
    {
	if ( !can_mmodify( ch, victim ) )
	  return;
	if ( value < 0 || value > 10000 )
	{
	    send_to_char( "El rango de las practicas ha sido establecido de 0 a 10000.\n\r", ch );
	    return;
	}
	...
	if ( value < 0 || value > 10000 )
	{
	    send_to_char( "El rango de puntos de quest es de 0 a 10000.\n\r", ch );
	    return;
	}
...
if ( !str_cmp( arg2, "genepdeaths" ) )
        {
         ...
         if ( value < 0 || value > 140 )
         	{
		 send_to_char( "El rango es de 0 a 140.\n\r", ch);
		 return;
		}
	 victim->pcdata->genepdeaths = value;
	 return;
	}
	
if ( !str_cmp( arg2, "genepkills" ) )
 	{
 	if ( IS_NPC(victim) )
 		{
 		send_to_char( "No en mobs.\n\r", ch );
 	...
 	victim->pcdata->genepkills = value;
 	return;
 }
if ( !str_cmp( arg2, "generacion" ) )
    {
     if ( IS_NPC(victim) )
         {
          send_to_char( "No en mobs.\n\r", ch );
     ...
     if ( value < 1 || value > 13 )
         {
           send_to_char( "El rango es de 1 a 13.\n\r", ch);
           return;
         }
                                         
     victim->generacion = value;
     return;
    }
	...
	{
	    send_to_char( "El rango de puntos de quest es de 0 a 30000.\n\r", ch );
	    return;
	}
	...
	if ( IS_NPC(victim) )
	{
	    send_to_char( "No en no jugadores.\n\r", ch );
	    return;
	}

	if ( value < 0 || value > 100 )
	{
	    send_to_char( "El rango de la sed es de 0 a 100.\n\r", ch );
	    return;
	}
	...
	if ( value < 0 || value > 100 )
	{
	    send_to_char( "El nivel de alcoholemia varia de 0 a 100.\n\r", ch );
	    return;
	}
	...
	if ( value < 0 || value > 100 )
	{
	    send_to_char( "El rango del hambre es de 0 a 100.\n\r", ch );
	    return;
	}
	...
	if ( value < 0 || value > MAX_LEVEL+1000 )
	{
	    ch_printf( ch, "El rango de sangre es de 0 a %d.\n\r", MAX_LEVEL+1000 );
	    return;
	}
	...
	DEITY_DATA *deity;
        ...
        if ( !deity )
        {
           send_to_char( "Deidad no encontrada.\n\r", ch );
           return;
        }
        STRFREE( victim->pcdata->deity_name );
	...
	if ( !arg3 || arg3[0] == '\0' )
	{
	    ...
	    send_to_char( "Quitado del consejo.\n\rPor favor ajusta los miembros del consejo para que concuerden.\n\r", ch );
	    return;
	}
...
void do_oset( CHAR_DATA *ch, char *argument )
{
    ...
    if( !str_prefix( arg2, "propietario" ) )
    {
        if( !IS_OBJ_STAT( obj, ITEM_QUEST ) && !IS_OBJ_STAT( obj, ITEM_LOYAL ) )
        {
                send_to_char( "Solo a objetos tipo Quest o Leal.\n\r", ch );
                return;
        }
        else
        {
		...
		if (obj->propietario != NULL)
                	STRFREE( obj->propietario );
                obj->propietario = STRALLOC( arg3 );
		ch_printf( ch, "Oset propietario: %s.\n\r",STRALLOC(arg3 ));
 		/*KAYSER 2004*/		
        }
        return;
     }
	 ...
	 */
	  ...
	  obj->short_descr = STRALLOC( arg3 );
          ...
          {
                      sprintf( buf, "%s %s", obj->name, "turbio");
                       STRFREE( obj->name );
...
void fold_area( AREA_DATA *tarea, char *filename, bool install )
{
    ...
    fprintf( fpout, "#REVISADA %d\n", tarea->revisada );
    fprintf( fpout, "#CONQUISTABLE %d\n", tarea->conquistable );
    //fprintf( fpout, "#RECURSOS %d %d %d %d %d", tarea->recursos->madera, tarea->recursos->mineral, tarea->recursos->combustible, tarea->recursos->agua, tarea->recursos->viveres );
    if( tarea->conquistable != 1)
    fprintf( fpout, "#PROPIETARIO %s~\n", tarea->propietario ? tarea->propietario : "Territorio Virgen" );
    else
    fprintf( fpout, "#PROPIETARIO %s~\n", tarea->propietario ? tarea->propietario : "Inconquistable" );

    fprintf( fpout, "#PUNTOS %d %d %d %d %d\n", tarea->puntos[0], tarea->puntos[1], tarea->puntos[2], tarea->puntos[3], tarea->puntos[4] );
...
/* Need to convert to new positions correctly on loadup sigh -Shaddai */
	...
	case ITEM_SCROLL:
		...
		else	val1 = HAS_SPELL_INDEX;} /* val2 */
	    if ( IS_VALID_SN(val3) )
		{if ( AREA_VERSION_WRITE == 0 ) val3 = skill_table[val3]->slot;
		else	val1 = HAS_SPELL_INDEX;}           /* val3 */
	    break;
	case ITEM_STAFF:
	case ITEM_WAND:
	    if ( IS_VALID_SN(val3) )
...
void do_aset( CHAR_DATA *ch, char *argument )
{
    ...
    {
	send_to_char( "Uso: aset <nombre archivo> <campo> <valor>\n\r", ch );
	send_to_char( "\n\rCampos admitidos:\n\r", ch );
